...
HD_PWD='C:/Users/wlsgh/lab1_07_demux_1x8/demux_1x8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log demux_1x8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source demux_1x8.tcl -notrace
